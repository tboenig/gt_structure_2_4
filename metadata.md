...
<div class="metadata">
   ...
   <dl class="grid">
      ...
      <dt>Description:</dt>
      <dd>The repo gt_structure_2_4 is part of the OCR-D Ground Truth Structure corpus. Only the structure of the printed page is annotated. The corpus was created as a result of the DFG project OCR-D. Corrections and extensions can be reported, please use the Issues.</dd>
      <dt>Language:</dt>
      <dd>deu</dd>
      <dt>Format:</dt>
      <dd>Page-XML</dd>
...
<div class="metadata">
   ...
   <ul>
      <li>
         <a href="https://github.com/OCR-D/gt_structure_2_4/releases/tag/v1.4.2">The BagIt 'ocrd.zip' files for the current version, please download them from the latest release.: Release 33_v1.4.2</a>
      </li>
      <li>
         <a href="https://github.com/OCR-D/gt_structure_2_4/releases">Version archive</a>
      </li>
   </ul>
</div>
<div class="metadata">
